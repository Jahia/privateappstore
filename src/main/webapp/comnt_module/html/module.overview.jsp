    ...
    <div class="mainContentWrapper">
        ...
        <section class="moduleDescription">
            ...
            <footer>
                ...
                <a class="btn btn-small btn-success" href="${authorURL}"><fmt:message key="comnt_module.label.authorURL"/></a>
                <a class="btn btn-small btn-success" href="mailto:${authorEmail}?Subject=${title}%20-%20Version:%20${version.string}"><fmt:message key="comnt_module.label.authorEmail"/></a>
