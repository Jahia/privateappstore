...
<div class="module moduleviewdetail">
    ...
    <div class="moduleinfo">
        ...
        <c:if test="${not empty currentNode.properties.description.string}"> -
            <fmt:message key="jnt_forgeModule.description"/>
    ...
    <div class="modulescreenshots">
        <c:if test="${not empty currentNode.properties.screenshot1.node}">
            <fmt:message key="jnt_forgeModule.screenshot1"/>:
            <div>
        ...
        <c:if test="${not empty currentNode.properties.screenshot2.node}">
            <fmt:message key="jnt_forgeModule.screenshot2"/>:
            <div>
        ...
        <c:if test="${not empty currentNode.properties.screenshot3.node}">
            <fmt:message key="jnt_forgeModule.screenshot3"/>:
            <div>
        ...
        <c:if test="${not empty currentNode.properties.screenshot4.node}">
            <fmt:message key="jnt_forgeModule.screenshot4"/>:
            <div>
    ...
    <c:if test="${currentNode.properties.supportedByJahia.boolean}">
        <div class="supportedByJahia"><fmt:message key="jnt_forgeModule.supportedByJahia"/></div>
    </c:if>

    <c:if test="${currentNode.properties.reviewedByJahia.boolean}">
        <div class="reviewedByJahia"><fmt:message key="jnt_forgeModule.reviewedByJahia"/></div>
    </c:if>
