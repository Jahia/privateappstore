...
<template:addResources type="css" resources="forgeModule.css"/>
...
<section id="moduleHeader" class="box box-rounded">
    ...
    <img class="moduleIcon" src="${icon.url}" alt="<fmt:message key="jnt_forgeModule.label.moduleIcon"><fmt:param value="${title}"/></fmt:message>"/>
