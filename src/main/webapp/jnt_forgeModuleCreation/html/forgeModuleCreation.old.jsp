...
<uiComponents:ckeditor selector="jahia-module-description-${id}"/>
...
<c:choose>
    <c:when test="${jcr:isNodeType(renderContext.mainResource.node,'comnt:module')}">
        ...
        <jcr:nodeProperty node="${renderContext.mainResource.node}" name="description" var="description"/>
    ...
    <c:otherwise>
        <c:set var="targetNode" value="${url.base}${modulesRepository.node.path}"/>
    ...
    <form action="<c:url value='${targetNode}.${edition ? "editModule" : "addModule"}.do'/>" method="post" id="moduleForm-${id}" class="moduleForm" enctype="multipart/form-data"  accept="application/json">
        <fieldset>
            ...
            <div class="control-group">
                <label class="control-label" for="jcr:title"><fmt:message key="jnt_forgeModule.title"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.title" />" class="span16" type="text"
                           name="jcr:title" id="jcr:title" value="${title.string}"/>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="authorName"><fmt:message key="jnt_forgeModule.authorName"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.authorName" />" class="span16" type="text"
                           name="authorName" id="authorName" value="${authorName.string}"/>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="authorURL"><fmt:message key="jnt_forgeModule.authorURL"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.authorURL" />" class="span16" type="text"
                           name="authorURL" id="authorURL" value="${authorURL.string}"/>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="authorEmail"><fmt:message key="jnt_forgeModule.authorEmail"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.authorEmail" />" class="span16" type="text"
                           name="authorEmail" id="authorEmail" value="${authorEmail.string}"/>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="codeRepository"><fmt:message key="jnt_forgeModule.codeRepository"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.codeRepository" />" class="span16" type="text"
            ...
            <c:forEach var="i" begin="1" end="${screenshotsMaxNbr}">
                ...
                <div class="control-group screenshot ${i > screenshotInputsDefaultNbr ? 'hidden-control-group' : '' }">
                    <label class="control-label" for="screenshot${i}"><fmt:message key="jnt_forgeModule.screenshot"/>&nbsp;${i}</label>
                    <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label" for="videoProvider"><fmt:message key="jnt_forgeModule.videoProvider"/></label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label" for="videoIdentifier"><fmt:message key="jnt_forgeModule.videoIdentifier"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.videoIdentifier" />" class="span16" type="text"
                           name="videoIdentifier" id="videoIdentifier" value="${videoIdentifier.string}"/>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="videoWidth"><fmt:message key="jnt_forgeModule.videoWidth"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.videoWidth" />" class="span16" type="text"
            ...
            <div class="control-group">
                <label class="control-label" for="videoHeight"><fmt:message key="jnt_forgeModule.videoHeight"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.videoHeight" />" class="span16" type="text"
                           name="videoHeight" id="videoHeight" value="${videoHeight.string}"/>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="videoAllowfullscreen"><fmt:message key="jnt_forgeModule.videoAllowfullscreen"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.videoAllowfullscreen" />" class="span16" type="checkbox"
                           name="videoAllowfullscreen" id="videoAllowfullscreen" checked="${videoAllowfullscreen.string}"/>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="icon"><fmt:message key="jnt_forgeModule.icon"/></label>
                <div class="controls">
                    <input placeholder="<fmt:message key="jnt_forgeModule.icon" />" class="span16" type="file"
                           name="icon" id="icon" />
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="description"><fmt:message key="jnt_forgeModule.description"/></label>
                <div class="controls">
                    <textarea rows="7" cols="35" id="jahia-module-description-${id}"
                              placeholder="<fmt:message key="jnt_forgeModule.description" />" class="jahia-ckeditor span16"
                              name="description" >
                        <c:if test="${not empty description.string}">
                            ${fn:escapeXml(description.string)}
                        </c:if>
                    </textarea>
                </div>
            </div>
            ...
            <c:if test="${not empty licenseCategory.node}">
                <div class="control-group">
                    <label class="control-label" for="jahiAppLicense"><fmt:message key="jnt_forgeModule.jahiAppLicense"/></label>
                    <div class="controls">
            ...
            <c:if test="${not empty moduleCategories}">
                ...
                <select id="moduleCategory" name="moduleCategory">
                    <option value=""><fmt:message key="jnt_forgeModule.category"/></option>
            ...
            <div class="control-group">
                <label class="control-label" for="newTag"><fmt:message key="jnt_forgeModule.tags"/></label>
                <div class="controls">
                    <input type="hidden" value="" name="deletedTag" id="deletedTag" />
                    <input placeholder="<fmt:message key="jnt_forgeModule.tags" />" type="text"
            ...
            <div class="control-group">
                <label class="control-label" for="jahia-module-howToInstall-${id}"><fmt:message key="jnt_forgeModule.howToInstall"/></label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label" for="jahia-module-FAQ-${id}"><fmt:message key="jnt_forgeModule.FAQ"/></label>
                <div class="controls">
            ...
            <c:if test="${jcr:hasPermission(currentNode, 'reviewModule')}">
                <div class="control-group">
                    <label class="control-label" for="supportedByJahia"><fmt:message key="jnt_forgeModule.supportedByJahia"/></label>
                    <div class="controls">
                        <input placeholder="<fmt:message key="jnt_forgeModule.supportedByJahia" />" class="span16" type="checkbox"
                               name="supportedByJahia" id="supportedByJahia" value="true" <c:if test="${supportedByJahia.boolean}">checked="true"</c:if>"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="reviewedByJahia"><fmt:message key="jnt_forgeModule.reviewedByJahia"/></label>
                    <div class="controls">
                        <input placeholder="<fmt:message key="jnt_forgeModule.reviewedByJahia" />" class="span16" type="checkbox"
            ...
            <div class="control-group">
                <div class="controls">
                    <input type="submit" class="btn" onclick="CKEDITOR.instances['jahia-module-description-${id}'].updateElement();" value="<fmt:message key="forge.label.submit" />"/>
                </div>
            </div>
        </fieldset>
    </form>
