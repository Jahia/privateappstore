...
<a class="btn btn-primary btn-block btn-file-upload" href="${link}" ${target} ${linkTitle}><i class="icon-plus-sign icon-white"></i>&nbsp;${fn:escapeXml(not empty title.string ? title.string : currentNode.name)}</a>